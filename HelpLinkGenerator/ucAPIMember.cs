...
namespace HelpLinkGenerator {
    public partial class ucAPIMember : UserControl {
        ...
        object GetDefaultData(int rowIndex, string propertyName) {
            ...
            switch (propertyName) {
                ...
                case "Member": {
                        ...
                        string fullMemberName = splitString[2]
                            .Remove(splitString[2].Length - 3, 3); //remove extension
                        string res = rgx.Replace(fullMemberName, replacement); //remove numeric ID
                        if (res.EndsWith("``")) return (res + "1");
                        else return res;
                    }
        ...
        private void gridView1_FocusedRowChanged(object sender, FocusedRowChangedEventArgs e) {
            ...
            buttonEdit1.EditValue = GenerateMarkdownLink(view, "Copy Markdown Link - Member");
        }
        ...
        public string GenerateMarkdownLink(GridView sourceView, string objectType) {
            ...
            string MemberName = view.GetFocusedRowCellDisplayText("Member");
            
            string MemberLink = "[" + ClassName + "." + MemberName + "]" + "(xref:" + NamespaceName + "." + ClassName + "." + MemberName + ")";
            string ClassLink = "[](xref:" + NamespaceName + "." + ClassName + ")";
            string NamespaceLink = "[](xref:" + NamespaceName + ")";
            switch (objectType) {
                case ("Copy Markdown Link - Member"):
                    return MemberLink;
        ...
        private void gridView1_PopupMenuShowing(object sender, PopupMenuShowingEventArgs e) {
            if (e.MenuType == GridMenuType.Row) {
                ...
                menu.Items.Clear();
                menu.Items.Add(CreateMenuItem("Copy Markdown Link - Member", null));
